...
type FeedBlog = Node & {
  ...
  readonly content: Maybe<FeedBlogContent>;
...
type FeedBlogContent = {
  readonly encoded: Maybe<Scalars['String']>;
  readonly encodedSnippet: Maybe<Scalars['String']>;
};
...
type Query = {
  ...
  readonly feedBlogMeta: Maybe<FeedBlogMeta>;
  readonly allFeedBlogMeta: FeedBlogMetaConnection;
  readonly feedBlog: Maybe<FeedBlog>;
  readonly allFeedBlog: FeedBlogConnection;
...
type Query_allFeedBlogMetaArgs = {
...
type Query_feedZennMetaArgs = {
  ...
  paginationLinks: Maybe<FeedZennMetaPaginationLinksFilterInput>;
  title: Maybe<StringQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  generator: Maybe<StringQueryOperatorInput>;
  link: Maybe<StringQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.allowNamespaces'
...
type FeedBlogMetaConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedBlogMetaEdge>;
  readonly nodes: ReadonlyArray<FeedBlogMeta>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<FeedBlogMetaGroupConnection>;
};


type FeedBlogMetaConnection_distinctArgs = {
  field: FeedBlogMetaFieldsEnum;
};


type FeedBlogMetaConnection_maxArgs = {
  field: FeedBlogMetaFieldsEnum;
};


type FeedBlogMetaConnection_minArgs = {
  field: FeedBlogMetaFieldsEnum;
};


type FeedBlogMetaConnection_sumArgs = {
  field: FeedBlogMetaFieldsEnum;
};


type FeedBlogMetaConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: FeedBlogMetaFieldsEnum;
};

type FeedBlogMetaEdge = {
  readonly next: Maybe<FeedBlogMeta>;
  readonly node: FeedBlogMeta;
  readonly previous: Maybe<FeedBlogMeta>;
};

type FeedBlogMetaFieldsEnum =
  | 'id'
  | 'parent.id'
  | 'parent.parent.id'
  | 'parent.parent.parent.id'
...
type FeedBlogMetaGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedBlogMetaEdge>;
  readonly nodes: ReadonlyArray<FeedBlogMeta>;
  readonly pageInfo: PageInfo;
...
type FeedBlogMetaSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedBlogMetaFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type FeedBlogContentFilterInput = {
  readonly encoded: Maybe<StringQueryOperatorInput>;
  readonly encodedSnippet: Maybe<StringQueryOperatorInput>;
};

type FeedBlogConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<FeedBlogEdge>;
  readonly nodes: ReadonlyArray<FeedBlog>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<FeedBlogGroupConnection>;
};


type FeedBlogConnection_distinctArgs = {
  field: FeedBlogFieldsEnum;
};


type FeedBlogConnection_maxArgs = {
  field: FeedBlogFieldsEnum;
};


type FeedBlogConnection_minArgs = {
  field: FeedBlogFieldsEnum;
};


type FeedBlogConnection_sumArgs = {
  field: FeedBlogFieldsEnum;
};


type FeedBlogConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: FeedBlogFieldsEnum;
};
...
type FeedBlogEdge = {
  readonly next: Maybe<FeedBlog>;
  readonly node: FeedBlog;
  readonly previous: Maybe<FeedBlog>;
};

type FeedBlogFieldsEnum =
  | 'id'
  | 'parent.id'
  | 'parent.parent.id'
  | 'parent.parent.parent.id'
...
type FeedBlogFilterInput = {
  ...
  readonly content: Maybe<FeedBlogContentFilterInput>;
...
type FeedBlogSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedBlogFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type FeedZennMetaFilterInput = {
  ...
  readonly paginationLinks: Maybe<FeedZennMetaPaginationLinksFilterInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly generator: Maybe<StringQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
...
type ArticleFeedQueryVariables = Exact<{ [key: string]: never; }>;


type ArticleFeedQuery = { readonly allFeedBlog: (
    Pick<FeedBlogConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: Pick<FeedBlog, 'contentSnippet' | 'title' | 'link' | 'isoDate'> }> }
  ), readonly allFeedZenn: (
    Pick<FeedZennConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: Pick<FeedZenn, 'contentSnippet' | 'title' | 'link' | 'isoDate'> }> }
  ) };
...
type useSiteQuery = { readonly site: Maybe<(
    Pick<Site, 'buildTime'>
    & { readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }
  )> };
